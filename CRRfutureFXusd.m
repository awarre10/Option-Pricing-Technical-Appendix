...
% Option: 3 month vanilla call on a EUR/USD Currency Future (3/31/2022) - Data from Bloomberg LP
...
% Enter model parameters
  ...
  sigma  = 0.31287;             % annual volatility
  r      = 0;                   % annual interest rate
  strike = 1.105;               % option strike price
  p0     = 1.10477;             % current asset price 
