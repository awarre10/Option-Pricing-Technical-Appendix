...
% Option: USD/GBP 3 month vanilla call (3/31/2022) - Data from Bloomberg LP
...
% Enter model parameters
  ...
  sigma  = 0.080295;            % annual volatility
  r      = 0.025;               % annual interest rate
  strike = 0.8255;              % option strike price
  p0     = 0.7612;              % current asset price 
