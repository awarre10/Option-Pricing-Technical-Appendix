...
% Option: USD/JPY 3 month vanilla call (3/31/2022) - Data from Bloomberg LP
...
% Enter model parameters
  ...
  sigma  = 0.085955;            % annual volatility
  r      = 0.025;               % annual interest rate
  strike = 130.25;              % option strike price
  p0     = 121.25;              % current asset price 
