...
% Option: 3 month vanilla call on the Dow Jones Industrial Average ETF (DIA)
...
% Enter model parameters
  ...
  sigma  = 0.16986;             % annual volatility
  r      = 0.025;               % annual interest rate
  strike = 380.48;              % option strike price
  p0     = 348.01;              % current asset price 
