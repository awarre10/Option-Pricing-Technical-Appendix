...
% Option: USD/EUR 3 month vanilla call (3/31/2022) - Data from Bloomberg LP
...
% Enter model parameters
  ...
  sigma  = 0.07505;             % annual volatility
  r      = 0.025;               % annual interest rate
  strike = 0.8991;              % option strike price
  p0     = 0.9028;              % current asset price 
