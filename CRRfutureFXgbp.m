% Cox-Ross-Rubinstein Binomial Call Option Pricing
% Option: 3 month vanilla call on a EUR/GBP Currency Future (3/31/2022) - Data from Bloomberg LP
% Future sourced from EUX
...
% Enter model parameters
  T      = 0.25;                % years to expiration
  sigma  = 0.30280;             % annual volatility
  r      = 0;                   % annual interest rate
  strike = 0.8425;              % option strike price
  p0     = 0.84272;             % current asset price 
