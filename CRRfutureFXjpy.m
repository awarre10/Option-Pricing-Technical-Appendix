...
% Option: 3 month vanilla call on a EUR/JPY Currency Future (3/31/2022) - Data from Bloomberg LP
...
% Enter model parameters
  ...
  sigma  = 0.09968;             % annual volatility
  r      = 0;                   % annual interest rate
  strike = 135.75;              % option strike price
  p0     = 135.645;             % current asset price 
